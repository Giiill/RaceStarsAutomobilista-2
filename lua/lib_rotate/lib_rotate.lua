...
function LibRotate:merge_setup( setup )
	...
	local attributes = { ServerControlsTrack = 0, ServerControlsVehicleClass = 0, ServerControlsVehicle = 0, PracticeDateProgression = 1, QualifyDateProgression = 1, RaceDateProgression = 1 }
...
function LibRotate:_merge_attributes( attributes, setup )
	...
	for k,v in pairs( setup ) do
		...
		elseif k == "MultiClassSlot1" or k == "MultiClassSlot2" or k == "MultiClassSlot3" or k == "MultiClassSlot4" or k == "MultiClassSlot5" or k == "MultiClassSlot6" or k == "MultiClassSlot7" or k == "MultiClassSlot8" or k == "MultiClassSlot9"or k == "MultiClassSlot10" then
			local class = id_to_vehicle_class[ normalize_vehicle_class( v ) ]
			if class then
	...
	-- Fix up real weather progression
	if attributes.PracticeWeatherSlots == 0 then
		if attributes.PracticeDateProgression > 0 then
			...
			print("[lib_rotate] Practice is set to Real Weather. Setting weather progression equal to date progression. (" .. attributes.PracticeDateProgression .. ")")
		else
			attributes.PracticeWeatherProgression = 1
			print("[lib_rotate] Practice is set to Real Weather. Setting weather progression to real time.")
		end
	end
	if attributes.QualifyWeatherSlots == 0 then
		if attributes.QualifyDateProgression > 0 then
			...
			print("[lib_rotate] Qualify is set to Real Weather. Setting weather progression equal to date progression. (" .. attributes.QualifyDateProgression .. ")")
		else
			attributes.QualifyWeatherProgression = 1
			print("[lib_rotate] Qualify is set to Real Weather. Setting weather progression to real time.")
		end
	end
	if attributes.RaceWeatherSlots == 0 then
		if attributes.RaceDateProgression > 0 then
			...
			print("[lib_rotate] Race is set to Real Weather. Setting weather progression equal to date progression. (" .. attributes.RaceDateProgression .. ")")
		else
			attributes.RaceWeatherProgression = 1
			print("[lib_rotate] Race is set to Real Weather. Setting weather progression to real time.")
		end
	end
