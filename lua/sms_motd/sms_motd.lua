...
local function send_now( refid )
	...
	if send_setup.restrictions then
		...
		if attributes.DamageScale == Damage.LOW then table.insert( restricts, "Damage Scale: Low" )
		elseif attributes.DamageScale == Damage.MEDIUM then table.insert( restricts, "Damage Scale: Medium" )
		elseif attributes.DamageScale == Damage.HIGH then table.insert( restricts, "Damage Scale: High" )
		elseif attributes.DamageScale == Damage.MAX then table.insert( restricts, "Damage Scale: Max" )
		end
		...
		elseif attributes.TireWearType == TireWear.X2 then table.insert( restricts, "Tire wear: X2" )
		elseif attributes.TireWearType == TireWear.X3 then table.insert( restricts, "Tire wear: X3" )
		elseif attributes.TireWearType == TireWear.X4 then table.insert( restricts, "Tire wear: X4" )
		elseif attributes.TireWearType == TireWear.X5 then table.insert( restricts, "Tire wear: X5" )
		...
		elseif attributes.FuelUsageType == FuelUsage.X2 then table.insert( restricts, "Fuel usage: X2" )
		elseif attributes.FuelUsageType == FuelUsage.X3 then table.insert( restricts, "Fuel usage: X3" )
		elseif attributes.FuelUsageType == FuelUsage.X4 then table.insert( restricts, "Fuel usage: X4" )
		elseif attributes.FuelUsageType == FuelUsage.X5 then table.insert( restricts, "Fuel usage: X5" )
		end
		SendChatToMember( refid, "- " .. table.concat( restricts, ", " ) )
	...
	if send_setup.date then
		SendChatToMember( refid, "Starting time: " .. attributes.RaceDateYear .. "-" .. attributes.RaceDateMonth .. "-" .. attributes.RaceDateDay .. " " .. attributes.RaceDateHour .. ":00" )
